...
import com.example.labe4_ex1.databinding.FragmentItemListBinding;
import com.example.labe4_ex1.databinding.ItemListContentBinding;
...
public class ItemListFragment extends Fragment {
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            holder.mContentView.setText(mValues.get(position).cImage);
            ...
            holder.itemView.setOnLongClickListener(v -> {
                ...
                ClipData dragData = new ClipData(
                        ((PlaceholderContent.PlaceholderItem) v.getTag()).cImage,
